...
class map_generator(object):
    ...
    def init_params(self):
        ...
        self.rate = rospy.get_param("~sensing/rate", default=0.5)
    ...
    def make_map(self):
        ...
        # forest map
        # self.add_box([2.0, 2.0, 1.0], [-2.0, -5.5, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [-3.0, 4.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [10.0, -2.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [5.0, -8.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [-10.0, 0.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [5.0, 14.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [-4.0, 13.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [2.0, 0.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [-10.0, 15.0, 0.3])
        # self.add_box([4.0, 2.0, 1.0], [6.0, 6.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [-8.0, -10.0, 0.3])
        # self.add_box([2.0, 2.0, 1.0], [0.0, 0.0, 0.3])
        
        # corridor
        self.add_box([8.0, 2.0, 1.0], [-2.0, -5.5, 0.3])
        self.add_box([2.0, 8.0, 1.0], [-3.0, 4.0, 0.3])
        self.add_box([10.0, 2.0, 1.0], [10.0, -2.0, 0.3])
        self.add_box([2.0, 8.0, 1.0], [5.0, -8.0, 0.3])
        self.add_box([2.0, 10.0, 1.0], [-10.0, 0.0, 0.3])
        self.add_box([14.0, 2.0, 1.0], [5.0, 14.0, 0.3])
        self.add_box([2.0, 10.0, 1.0], [-6.0, 13.0, 0.3])
        self.add_box([8.0, 2.0, 1.0], [2.0, 2.0, 0.3])
        self.add_box([2.0, 10.0, 1.0], [-10.0, 15.0, 0.3])
        self.add_box([8.0, 2.0, 1.0], [6.0, 6.0, 0.3])
        self.add_box([2.0, 8.0, 1.0], [-8.0, -10.0, 0.3])
        self.add_box([4.0, 2.0, 1.0], [-7.0, 0.0, 0.3])
